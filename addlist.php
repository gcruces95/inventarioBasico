...
<body>
    ...
    <div class="content">
        ...
        <div class="addproduct">
            <form action="main/addlist.php" method="POST">
                ...
                <input type="text" name="usuario" placeholder="Usuario del equipo" required />

                <br>

                <label for="ubicacion">UBICACIÓN:</label><br>
                <input type="text" name="ubicacion" placeholder="Ubicación del equipo" required />
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($query)) { ?>
                        <tr>
                            ...
                            <td class="modify"><a name="edit" id="" class="bfix" href="fix.php?id=<?php echo $row['id'] ?>
                            &nombre=<?php echo $row['nombre'] ?>&marca=<?php echo $row['marca']?>&modelo=<?php echo $row['modelo']?>
                            &procesador=<?php echo $row['procesador']?>&direccion=<?php echo $row['direccion']?>&departamento=<?php echo $row['departamento']?>
                            &usuario=<?php echo $row['usuario']?>&ubicacion=<?php echo $row['ubicacion']?>" role="button">
                                    Editar
                                </a></td>
